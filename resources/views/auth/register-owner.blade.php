...
<head>
    ...
    <title>Beach Owner Registration</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-blue-50 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md bg-white p-8 rounded shadow">
        <h2 class="text-2xl font-bold mb-6 text-center text-blue-700">Register as Beach Owner</h2>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Beach Owner Registration - Beach Tourism</title>
...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl card-shadow overflow-hidden max-w-5xl w-full grid md:grid-cols-2">
        ...
        <div class="p-8 md:p-12 flex flex-col justify-center">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-800 mb-2">Register as Beach Owner</h1>
                <p class="text-gray-500 text-sm">Share your beach with the world</p>
            </div>
            ...
            <div class="mt-6 space-y-2">
                <p class="text-center text-sm text-gray-600">
                    Are you a tourist?
                    <a href="{{ route('register') }}" class="text-cyan-600 hover:text-cyan-700 font-semibold">Tourist Registration</a>
                </p>
                <p class="text-center text-sm text-gray-600">
                    Already have an account?
        ...
        <div class="hidden md:flex bg-gradient-to-br from-cyan-50 to-teal-50 p-12 flex-col justify-center items-center relative overflow-hidden">
            ...
            <div class="mt-8 text-center relative z-10">
                <h2 class="text-2xl font-bold text-gray-800 mb-3">Showcase Your Beach</h2>
                <p class="text-gray-600 text-sm leading-relaxed max-w-sm">
                    Register as a beach owner to list your properties and connect with tourists from around the world.
                </p>
            </div>
